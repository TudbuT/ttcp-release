...
public class WorldGeneratorV2 extends MinecraftServer {
    ...
    public static WorldGeneratorV2 create(WorldSettings settings) {
        ...
        return new WorldGeneratorV2(TTCp.mc, settings, as, as.createMinecraftSessionService(), gpr, new PlayerProfileCache(gpr, new File("ttc/usercache.json")));
    }
    
    public WorldGeneratorV2(Minecraft clientIn, WorldSettings worldSettingsIn, YggdrasilAuthenticationService authServiceIn, MinecraftSessionService sessionServiceIn,
    ...
    public void loadAllWorlds(String saveName, String worldNameIn, long seed, WorldType type, String generatorOptions) {
        ...
        WorldServer overWorld = (
                isDemo() ? (WorldServer) (new WorldServerDemo(this, isavehandler, worldinfo, 0, this.profiler)).init() :
    ...
    public void tick() {
        ...
        if (this.isGamePaused) {
            ...
            if (TTCp.mc.gameSettings.renderDistanceChunks != this.getPlayerList().getViewDistance()) {
                LOGGER.info("Changing view distance to {}, from {}", TTCp.mc.gameSettings.renderDistanceChunks, this.getPlayerList().getViewDistance());
            ...
            WorldInfo worldinfo = TTCp.mc.world.getWorldInfo();
    ...
    public EnumDifficulty getDifficulty() {
        return TTCp.mc.world.getWorldInfo().getDifficulty();
    }
